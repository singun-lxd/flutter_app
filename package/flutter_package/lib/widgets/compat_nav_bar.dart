...
class PlatformNavBar extends BaseCompatWidget<CupertinoTabBar, BottomAppBar> {
  final Key widgetKey;
  final Color backgroundColor;
  ...
  final CompatBuilder<MaterialNavBarData> material;
  final CompatBuilder<CupertinoTabBarData> cupertino;
  ...
  @override
  BottomAppBar materialWidget(BuildContext context) {
  ...
  @override
  CupertinoTabBar cupertinoWidget(BuildContext context) {
